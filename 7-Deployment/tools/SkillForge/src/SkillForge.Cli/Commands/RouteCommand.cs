...
public sealed class RouteCommand : Command<RouteSettings>
{
    ...
    private static int RunSingle(RouteSettings settings, Core.Model.SkillSet set, IRoutingStrategy strategy)
    {
    ...
    private static int RunEval(RouteSettings settings, Core.Model.SkillSet set, IRoutingStrategy strategy)
    {
