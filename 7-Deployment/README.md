...
- `tools/KyberWeave/` — stub pointing at the extracted product ([dpalfery/kyber-weave](https://github.com/dpalfery/kyber-weave)); host overrides live in `.kyber-weave/kyber-weave.yml`.
