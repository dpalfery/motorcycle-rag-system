...
namespace SkillForge.Core.Validation;
...
public static class SpecValidator
{
    ...
    public static IEnumerable<Diagnostic> Validate(Skill skill)
    {
        ...
        {
            yield return new Diagnostic("SF-SPEC-001", Severity.Error,
        ...
        else
        {
            if (name!.Length > NameMaxLength)
                yield return new Diagnostic("SF-SPEC-002", Severity.Error,
                    $"'name' is {name.Length} chars; the spec limit is {NameMaxLength}.", skillId, file);

            if (!NamePattern.IsMatch(name))
                yield return new Diagnostic("SF-SPEC-003", Severity.Error,
            ...
            {
                yield return new Diagnostic("SF-SPEC-004", Severity.Error,
        ...
        {
            yield return new Diagnostic("SF-SPEC-005", Severity.Error,
        ...
        {
            yield return new Diagnostic("SF-SPEC-006", Severity.Error,
        ...
        {
            yield return new Diagnostic("SF-SPEC-007", Severity.Warning,
        ...
        {
            yield return new Diagnostic("SF-SPEC-009", Severity.Warning,
        ...
        {
            yield return new Diagnostic("SF-SPEC-010", Severity.Info,
