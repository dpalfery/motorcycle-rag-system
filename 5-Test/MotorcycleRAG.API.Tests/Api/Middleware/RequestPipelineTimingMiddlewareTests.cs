...
{
    private static RequestPipelineTimingMiddleware Create(RequestDelegate? next = null)
        => new(next ?? TestHelpers.NoopNext, NullLogger<RequestPipelineTimingMiddleware>.Instance);
