...
using SkillForge.Core.Routing;
using SkillForge.Core.Security;
using Xunit;
...
public class SkillScannerTests
{
    ...
    public void Flags_prompt_injection()
    {
        ...
        Assert.Contains("SF-SEC-001", codes);
    }
    ...
    public void Flags_hidden_html_comment_instructions()
    {
        ...
        Assert.Contains("SF-SEC-006", codes);
    }
    ...
    public void Flags_hardcoded_aws_key()
    {
        ...
        Assert.Contains("SF-SEC-020", codes);
    }
    ...
    public void Clean_skill_has_no_critical_findings()
    {
        ...
        Assert.DoesNotContain(diags, d => d.Severity == SkillForge.Core.Diagnostics.Severity.Critical);
    }
}
