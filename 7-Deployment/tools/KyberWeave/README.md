# Kyber-Weave (extracted)

Kyber-Weave no longer lives in this repository.

**Product source and releases:** https://github.com/dpalfery/kyber-weave

## Install

| Channel | Command / URL |
| --- | --- |
| GitHub Releases | https://github.com/dpalfery/kyber-weave/releases (pinned in CI as `v0.1.1`) |
