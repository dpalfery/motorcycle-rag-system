...
public class ScheduledProcessingStats
{
    ...
    /// <summary>
    /// Number of scheduled runs in last 24 hours
    /// </summary>
    public int Last24HourRuns { get; set; }
    
    /// <summary>
    /// Number of successful runs in last 24 hours
    /// </summary>
    public int Last24HourSuccesses { get; set; }
    
    /// <summary>
    /// Number of failed runs in last 24 hours
    /// </summary>
    public int Last24HourFailures { get; set; }
    
    /// <summary>
    /// Number of cancelled runs in last 24 hours
    /// </summary>
    public int Last24HourCancellations { get; set; }
    
    /// <summary>
    /// Total documents processed in last 24 hours
    /// </summary>
    public int DocumentsProcessedLast24Hours { get; set; }
    
    /// <summary>
    /// Total documents indexed in last 24 hours
    /// </summary>
