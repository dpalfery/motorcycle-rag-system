...
/// <summary>
/// Represents an entity node in the SQL Server Graph database.
...
public class GraphNode
{
    ...
    /// <summary>GUID of the source document (MotorcycleManual or BikeModel) this node was extracted from.</summary>
