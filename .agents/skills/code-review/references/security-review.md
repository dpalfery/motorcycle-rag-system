# Security Review (branch-diff vulnerability analysis)

Load this reference when the review must include a security pass on the changes. It finds real, exploitable, HIGH-CONFIDENCE vulnerabilities newly introduced by the diff.
