...
{
    public const string UnresolvedCodeRef = "SF-DOC-DRIFT-001";
    public const string UnresolvedEndpoint = "SF-DOC-DRIFT-002";
    public const string SourceRootNotIndexed = "SF-DOC-DRIFT-003";
