...
required_agent_files=(
  ...
  "5-Test/MotorcycleRAG.AgentProvisioning.Tests/AGENTS.md"
  "5-Test/MotorcycleRAG.Application.Tests/AGENTS.md"
  "5-Test/MotorcycleRAG.Contracts.Tests/AGENTS.md"
  "5-Test/MotorcycleRAG.Core.Tests/AGENTS.md"
  ...
  "5-Test/MotorcycleRAG.Persistence.Tests/AGENTS.md"
  "5-Test/MotorcycleRag.WebUI.BFF.Tests/AGENTS.md"
  "5-Test/local-processing-service.Tests/AGENTS.md"
