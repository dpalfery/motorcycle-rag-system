 ...
 - [x] 2. Implement packaged-install bootstrap asset discovery and preparation
 ...
 - [x] 3. Implement first-run initialization and subsequent-startup reuse flows
 ...
 - [x] 4. Build the desktop-owned processor lifecycle manager
 ...
 - [x] 5. Expose explicit processor health and status state to the application surface
 ...
 - [x] 6. Implement actionable failure classification and user-visible error states
 ...
 - [x] 8. Add traceable observability around bootstrap, lifecycle, and health operations
 ...
 - [x] 9. Wire end-to-end automated scenarios across packaged, first-run, restart, and failure flows
