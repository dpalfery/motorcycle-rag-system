...
| Core, Application, Domain, and Persistence | Architecture layers | `0-Base` through `4-Persistence` | [root README](../README.md) | [architecture rules](rules/architecture-general.md) | Architecture maintainers | 2026-07-15 | Current |
