...
| [2026-07-16 Domain entity setter encapsulation and inventory gate](2026-07-16-domain-entity-setter-encapsulation-and-inventory-gate.md) | Draft | Encapsulate the four violating entities (IngestionJob, BikeModel, ManualDocument, McpToolConfiguration) behind private ctors + Create/Rehydrate factories + named behavior, convert their Dapper repositories to Row+Map, drop IngestionJob's dead fields + legacy columns, and enable the skipped post-migration inventory gate. Completes criteria 3 and 6 of the 2026-07-13 plan. |
