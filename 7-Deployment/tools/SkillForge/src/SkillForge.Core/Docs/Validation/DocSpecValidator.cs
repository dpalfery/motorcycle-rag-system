...
namespace SkillForge.Core.Docs.Validation;
...
{
    public const string MissingFrontmatter = "SF-DOC-SPEC-001";
    public const string InvalidVocabulary = "SF-DOC-SPEC-002";
    public const string MissingRequiredKey = "SF-DOC-SPEC-003";
    public const string UnknownCatalogValue = "SF-DOC-SPEC-004";
    public const string SourceRootMissing = "SF-DOC-SPEC-005";
    public const string BadReference = "SF-DOC-SPEC-006";
        ...
        DiagnosticReport report)
    {
        ...
        // --- SF-DOC-SPEC-002: closed vocabularies ---------------------------------------
        ...
        // --- SF-DOC-SPEC-003: per-doc-type requirements ---------------------------------
        ValidateRequiredForType(doc, report);

        // --- SF-DOC-SPEC-004: catalog vocabularies --------------------------------------
        ...
        // --- SF-DOC-SPEC-005: source-root exists ----------------------------------------
        ...
        // --- SF-DOC-SPEC-006: identity and cross-references ------------------------------
