...
{
    /// <summary>
    /// Unique identifier for web source
    /// </summary>
    ...
    /// <summary>
    /// Display name for web source
    /// </summary>
    [Required]
    public string Name { get; set; } = string.Empty;

    /// <summary>
    /// Description of web source
    /// </summary>
    public string Description { get; set; } = string.Empty;

    /// <summary>
    /// Whether web source is enabled
    /// </summary>
    public bool IsEnabled { get; set; } = true;

    /// <summary>
    /// Trust tier for web source (1-5, with 5 being most trusted)
    /// </summary>
