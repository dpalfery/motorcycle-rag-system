---
description: Three-phase spec planning flow: requirements → design → tasks, with approval gates between each phase
agent: orchestrator
---
...
Delegate to the **architect** agent. Pass it: `feature_name` and the approved requirements.
...
- On anything short of explicit approval, collect feedback, re-delegate to **architect**, re-present, ask again. Repeat until approved.
