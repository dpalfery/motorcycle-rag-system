...
namespace SkillForge.Core.Agents.Security;
...
{
    public const string RuleSafetyBypass = "SF-AGENT-SEC-001";
    public const string RuleHardcodedSecret = "SF-AGENT-SEC-002";
    public const string RuleRiskyDirective = "SF-AGENT-SEC-003";
