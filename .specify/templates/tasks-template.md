...
**Tests**: Tests are REQUIRED by the constitution. Include test tasks for each
user story (unit/integration/E2E as applicable).

**Approval Gates**: If work adds dependencies, infrastructure or operations automation, generated
documentation, or cross-cutting behavior, include an explicit approval task before implementation.
...
- [ ] T004 Record required approvals for dependencies/infra/docs/cross-cutting work before implementation
...
- [ ] T011 Define validation steps that avoid direct cloud mutation and preserve the GitHub Actions-only deployment path
...
- [ ] TXXX Verify deployment-affecting changes remain compatible with the GitHub Actions-only path
